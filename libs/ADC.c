...
void ADC1Init(void){
  ...
  ADC1->SQR3 =
    0x0 << ADC_SQR3_SQ1_Pos // Bits 4:0 SQ1[4:0]: first conversion in regular sequence = 00000(CH0)
  ...
  | 0x4 << ADC_SQR3_SQ5_Pos;// Bits 24:20 SQ5[4:0]: first conversion in regular sequence = 00100(CH4)
  ADC1->SQR1 = 0x4 << ADC_SQR1_L_Pos;// Regular channel sequence length = 0100: 5 conversions 
  ADC1->SMPR2 = 
    0x7 << ADC_SMPR2_SMP0_Pos // 111: 239.5 cycles CH0
  ...
  | 0x7 << ADC_SMPR2_SMP4_Pos; // 111: 239.5 cycles CH3
